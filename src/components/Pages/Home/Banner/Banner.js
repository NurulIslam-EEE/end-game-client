        ...
        <div className="grid grid-cols-1 lg:grid-cols-2  h-full py-20 ">
          ...
          <Slider {...settings}>
            <div className="col-span-2 ">
              ...
              <button className="bg-teal-400 hover:bg-transparent text-white font-semibold hover:text-teal-400 py-2 px-4 border border-transparent hover:border-teal-400 rounded mb-4">Our Tours</button>
            </div>
            <div className="col-span-2 ">
              <h1 className="title">Feel The</h1>
              <h1 className="title">Freedom To Travel</h1>
